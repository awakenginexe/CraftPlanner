...
export default function App() {
  ...
  if (status.kind === "loading") {
    return <main className="flex min-h-screen items-center justify-center bg-zinc-950 text-zinc-100"><p className="text-sm text-zinc-400">Loading CraftPlanner...</p></main>;
  }
  ...
  return (
    <Layout activeScreen={activeScreen} title={screenTitles[activeScreen] ?? "CraftPlanner"} onNavigate={setActiveScreen}>
